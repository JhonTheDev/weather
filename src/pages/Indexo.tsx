    ...
    return Object.entries(dailyForecast).map(([date, items]) => {
      ...
      return {
        ...
        day: {
          ...
          maxwind_kph: 0, // Você pode adicionar isso se tiver dados
          ...
          daily_chance_of_rain: Math.round(Math.random() * 100), // Exemplo - ajuste conforme sua API
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-3">
            <div className="p-6 mb-6 bg-white dark:bg-gray-800 shadow-xl rounded-2xl">
